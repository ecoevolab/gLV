...
def training_NormalLoop(model_declared, device, batched_paths, weights_path, loss_fn, optimizer, epochs=100):
    #------------------------------------------
    ...
    return  loss_history, metrics_true, metrics_pred, idx_max_true, idx_max_pred, time_elapsed
...
result_path = os.path.join(result_dir, experiment_name, 'NormalMethod_testing')
...
# Section: Run Model
#-------------------------------
loss_history, metrics_true, metrics_pred, idx_max_true, idx_max_pred, time_elapsed = training_NormalLoop(model_declared, device, batched_paths, weights_path, loss_fn, optimizer, epochs)
