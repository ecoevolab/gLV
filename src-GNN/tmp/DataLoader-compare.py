...
# Section: Run Model
#-------------------------------
loss_history, metrics_true, metrics_pred, idx_max_true, idx_max_pred, time_elapsed = training_DLloop(model_declared, device, batched_paths, weights_path, loss_fn, optimizer, epochs)
