...
![Figure 1: Parameter analysis](/mnt/data/sur/users/mrivera/Data/PEA/params_space_heatmap.png)
...
![Figure 2: Solver tolerance analysis](/mnt/data/sur/users/mrivera/Data/PEA/tol_analysis/tolerance_heatmap.png)
...
![Figure 3: Metrics distributions]( "/mnt/data/sur/users/mrivera/Data/Controls/Cascade_keystone/all_metrics_distribution.png")

![Figure 4: Relative abundance and metrics]( "/mnt/data/sur/users/mrivera/Data/Controls/Cascade_keystone/keystone_relative_metrics.png")

![Figure 5: Metric distributions for survival species]( "/mnt/data/sur/users/mrivera/Data/Controls/Cascade_keystone/alive_metrics_distribution.png")
...
![Figure 6: Metrics distributions]("/mnt/data/sur/users/mrivera/Data/clean_controls/Negative_magnitude_d1e776c23c74/all_metrics_distribution.png")

![Figure 7: Keystone species relative abundance and metrics]("/mnt/data/sur/users/mrivera/Data/clean_controls/Negative_magnitude_d1e776c23c74/keystone_relative_metrics.png")

![Figure 8: Metric distributions for survival species]("/mnt/data/sur/users/mrivera/Data/clean_controls/Negative_magnitude_d1e776c23c74/alive_metrics_distribution.png")
...
![Figure 9: Metrics distributions]("/mnt/data/sur/users/mrivera/Data/Controls/Boosted_keystone/all_metrics_distribution.png")

![Figure 10: Keystone species relative abundance and metrics]("/mnt/data/sur/users/mrivera/Data/Controls/Boosted_keystone/keystone_relative_metrics.png")

![Figure 11: Metric distributions for survival species]("/mnt/data/sur/users/mrivera/Data/Controls/Boosted_keystone/alive_metrics_distribution.png")
