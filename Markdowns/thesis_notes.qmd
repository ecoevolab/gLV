...
![Figure 1: Parameter analysis](./Data/PEA/params_space_heatmap.png)
...
![Figure 2: Solver tolerance analysis](./Data/PEA/tol_analysis/tolerance_heatmap.png)
...
![Figure 3: Metrics distributions](./Data/Controls/Cascade_keystone/all_metrics_distribution.png)

![Figure 4: Relative abundance and metrics](./Data/Controls/Cascade_keystone/keystone_relative_metrics.png)

![Figure 5: Metric distributions for survival species](./Data/Controls/Cascade_keystone/alive_metrics_distribution.png)
...
![Figure 6: Metrics distributions](./Data/clean_controls/Negative_magnitude_d1e776c23c74/all_metrics_distribution.png)

![Figure 7: Keystone species relative abundance and metrics](./Data/clean_controls/Negative_magnitude_d1e776c23c74/keystone_relative_metrics.png)

![Figure 8: Metric distributions for survival species](./Data/clean_controls/Negative_magnitude_d1e776c23c74/alive_metrics_distribution.png)
...
![Figure 9: Metrics distributions](./Data/Controls/Boosted_keystone/all_metrics_distribution.png)

![Figure 10: Keystone species relative abundance and metrics](./Data/Controls/Boosted_keystone/keystone_relative_metrics.png)

![Figure 11: Metric distributions for survival species](./Data/Controls/Boosted_keystone/alive_metrics_distribution.png)
...
![Figure 12: Metric distributions for survival species with full-community extinctions impact](./Data/clean_controls/ImpactAnalysis_9ee93e/full_metrics_distribution.png)

![Figure 13: Metric distributions for survival species with sub-community extinctions impact](./Data/clean_controls/ImpactAnalysis_9ee93e/sub_metrics_distribution.png)
