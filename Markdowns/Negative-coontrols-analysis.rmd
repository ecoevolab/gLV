...
path = file.path("/mnt/data/sur/users/mrivera/Plots/NegCtrls", "Keystone_thresholdsV2.png")
...
Sys.setenv(RSTUDIO_PANDOC = "/mnt/data/sur/modules/pandocs-V3.9/bin")
interactive_plot <- ggplotly(plt)
saveWidget(
  interactive_plot,
  file = "/mnt/data/sur/users/mrivera/Plots/NegCtrls/interactive_keystone_plot.html",
  selfcontained = TRUE
)
```