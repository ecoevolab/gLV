...
path = '/mnt/data/sur/users/mrivera/Plots/exp_20251125/Metric_distributions.png'
ggsave(path, plot = plt, width = 12, height = 5)
```

![Figure 2: Predictor metrics separated by keystone status and interaction network structure.](/mnt/data/sur/users/mrivera/Plots/exp_20251125/Metric_distributions.png)
...
![Figure 3: Distribution of predictor metrics separated by keystone status. The violin plots suggest that keystones and non-keystones differ in their metric values across all variables examined. ](/mnt/data/sur/users/mrivera/Plots/exp_20251125/TTS_simulation.png)
...
ggsave(path, plot = plt, width = 12, height = 5)
```
![Figure 4: Predictor metrics against relative abundance separated by keystone status. The violin plots suggest that keystones and non-keystones differ in their metric values across all variables examined. ](/mnt/data/sur/users/mrivera/Plots/exp_20251125/TTS_simulation.png)
