# This script is to generate plots for the thesis.
# 
# Plots are for cascade keystone simulations.

#-------------------------------------
# Section: Load data
#-------------------------------------
dir = '/mnt/data/sur/users/mrivera/Data/Controls/Cascade_keystone'
