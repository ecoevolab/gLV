# =============================================================================
# Control simulations — negative keystoneness magnitude
# =============================================================================
#
# Interaction matrix setup:
#   - Diagonal:          fixed at -0.5
#   - Column K:          U(-1, 0)
#   - Other off-diagonal: sparse mix of zeros and negatives from U(-2, -1)
#
# =============================================================================
...
# Section: Load data
#-------------------------------------
out_path = '/mnt/data/sur/users/mrivera/Data/clean_controls/Negative_magnitude_d1e776c23c74'
...
make_boxplot(
    ...
    subtitle = "Negative magnitude method"
...
plot_data <- full_summary %>%
    ...
    mutate(
        variable = factor(variable, levels = variables_to_plot),
